...
AI + quantum + classical analysis for testing and breaking post-quantum schemes (for academic/defensive research).
...
*  Over **300+ stars** across security & cryptography repos
...
* Research partnerships (quantum-safe protocols, cryptanalysis, simulation tools)
* Financial infrastructure pilots (validator nodes, tokenization)
